...
<div id="meal_body">
<div id="side_menu">
    <a class="ajax_link" href="meal_cocktails"><img class="active" src="<?= ABS_IMAGES ?>/cocktails.jpg" /></a>
    ...
    <a class="ajax_link" href="meal_meat-pasta"><img src="<?= ABS_IMAGES ?>/pasta.jpg" /></a>
    <a class="ajax_link" href="meal_meat-pasta"><?= MEAT_PASTA ?></a>
</div>
<?php
$handle = fopen(ABS_INCLUDE_COCKTAIL, "r");
if ($handle)
{
    ...
    while (($buffer = fgets($handle, 4096)) !== false)
    {
        ...
        if ($name == "NEW_TAB")
        {
            $html .= '</table><table class="meal_tables"><tr><img id="meal_photo" src="'.ABS_IMAGES.'/cocktails.jpg" /></tr><tr><th colspan="2" class="tab_title">'.$table_title.'</th></tr>';
            continue;
        }
