...
<div id="side_menu">
    ...
    <a class="ajax_link" href="meal_fish"><img class="active" src="<?= ABS_IMAGES ?>/fish.jpg" /></a>
...
<?php
$handle = fopen(ABS_INCLUDE_FISH, "r");
if ($handle)
{
    ...
    while (($buffer = fgets($handle, 4096)) !== false)
    {
        ...
        if ($name == "NEW_TAB")
        {
            $html .= '</table><table class="meal_tables"><tr><img id="meal_photo" src="'.ABS_IMAGES.'/fish.jpg" /></tr><tr><th colspan="2" class="tab_title">'.$table_title.'</th></tr>';
            continue;
        }
